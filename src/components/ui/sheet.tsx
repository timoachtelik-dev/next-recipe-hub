  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-baby-powder dark:bg-dark-surface dark:text-dark-gray-900 data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-white focus:ring-gray-300 data-[state=open]:bg-gray-100 dark:focus:ring-dark-gray-500/40 dark:data-[state=open]:bg-dark-gray-200 absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("text-gray-900 dark:text-dark-gray-900 font-semibold", className)}
      {...props}
    />
  )
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-gray-500 dark:text-dark-gray-500 text-sm", className)}
      {...props}
    />
  )
}
